## 0️⃣ Intro
- have an Expo mobile app and a Vite web app(for expo webview, admin).
- The Vite app is built using GitHub Actions for CI/CD.
- The Vite app is deployed to Firebase Hosting.
...
| `noSecrets` | Prevents storing passwords, API keys, etc. in the code |
